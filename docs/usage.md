...
articles/dataset/nf-core*metatdenovo_taxonomy/28211678), DOI: https://doi.org/10.17044/scilifelab.28211678.
\_Note:* If you can't download the files from FigShare from the command line with `wget` or `curl`, try URLs looking like
